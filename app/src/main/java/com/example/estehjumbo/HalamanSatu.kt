    ...
    Column (modifier = modifier,
        ...
        Modifier.padding(dimensionResource(id = R.dimen.padding_medium))) {
            ...
            Divider(
                ...
                Button(
                    modifier = Modifier.weight(if),
                        ...
                        Text(stringResources(R.string.confirm))
                    }
            }
            Divider(
                thickness = dimensionResource(R.dimen.thickness_divider),
            ...
            Row (
                ...
                horizontalArrangement =
                Arrangement.spacedBy(dimensionResource(R.dimen.padding_medium)),
                verticalAlignment = Allignment.bottom
            ) {

            }

             {
                OutlinedButton(modifier = Modifier.weight(if), onClick =
                onCancelButtonClicked) {
                    Text(stringResource(R.string.cancel))
                        ...
                        modifier = Modifier.weight(if),
                            ...
                            Text(stringResources(R.sting.next))
                        }
            }
        }
    }
